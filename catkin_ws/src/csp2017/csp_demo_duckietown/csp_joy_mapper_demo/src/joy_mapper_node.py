...
import math
import rospy
from duckietown_msgs.msg import Twist2DStamped, BoolStamped, Pixel
...
class JoyMapperNode(object):
	...
	def __init__(self):
		...
		self.pub_carcmd = rospy.Publisher("~car_cmd", Twist2DStamped, queue_size=1)
                ...
                self.pub_Grip = rospy.Publisher("~gripper_cmd", Pixel, queue_size=1)
